...
* If your change is non-trivial or introduces new public facing APIs (discussed in more detail below) please submit to [Discussions](https://github.com/microsoft/onnxruntime/discussions) under the Feature Requests category. This will allow you to discuss your change with the team and get consensus on the basic design and direction first. For all other changes, you can directly create a pull request (PR) and we'll be happy to take a look.
